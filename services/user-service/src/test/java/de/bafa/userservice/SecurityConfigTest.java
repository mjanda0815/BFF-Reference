 ...
 * is swapped out by a mocked {@link JwtDecoder} in {@link UserControllerTest} — still participates in
 * coverage. The decoder is built but never asked to resolve a JWKS, so no network I/O occurs.
 */
